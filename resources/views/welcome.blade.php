        ...
        @else
            <section class="h-screen w-full flex flex-col justify-center items-center gap-2 lg:gap-4 px-4">
                ...
                <p class="text-slate-600 text-center mt-4">
                    Vorrei condividere la tua esperienza per aiutare altri clienti a conoscere meglio i miei servizi.<br>
                    Ti chiedo il permesso di utilizzare in modo anonimo alcuni riscontri o testimonianze che mi hai fornito.<br>
